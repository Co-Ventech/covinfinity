  ...
  return (
    <MainLayout>
      ...
      >
        ...
        <p className='no-color font-extrabold text-3xl mb-8'> <span className='text-bykea'>(</span>Enhancing Cybersecurity<span className='text-bykea'>)</span></p>
        <p className='font-medium text-3xl max-w-[39.125rem] leading-[1.48]'>
          <span className="flex items-start gap-4 mb-4">
            <span className="w-2 h-2 rounded-full bg-[#B5BDC4] mt-4 flex-shrink-0"></span>
        ...
        <div className="flex flex-col gap-12 rotate 2xl:relative 2xl:-left-8">
          <div className="flex items-start gap-6">
            ...
            <div className="">
              ...
              <p className="text-[#B5BDC4] text-xl font-medium mt-4">We met with Bykea's leadership to discuss their key concerns and security requirements. The focus was on fortifying their digital infrastructure and protecting sensitive data.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="">
              ...
              <p className="text-[#B5BDC4] text-xl font-medium mt-4">Our team conducted a thorough penetration test and vulnerability assessment, focusing on their core infrastructure and network systems. Using industry-leading tools, we pinpointed potential security gaps.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="">
              ...
              <p className="text-[#B5BDC4] text-xl font-medium mt-4">Within 48 hours, Co-Ventech provided a comprehensive report, outlining the vulnerabilities found and offering clear recommendations to mitigate each risk. We worked closely with Bykea's technical team to implement these changes quickly and effectively.</p>
            </div>
          </div>
        </div>
      </ServiceSection>
      ...
      >
        ...
        <p className='font-medium text-[1.625rem] max-w-[39.125rem] leading-[1.48]'>
          <span className="flex items-start gap-4 mb-4">
            <span className="w-2 h-2 rounded-full bg-[#B5BDC4] mt-4 flex-shrink-0"></span>
