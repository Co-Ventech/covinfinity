...
export default function TestimonialSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      backContent: "More details about Tejas and how our platform helped streamline their workflow.",
    },
    {
      name: "Sarah",
      time: "11:32 AM",
          ...
          {testimonials.map((testimonial, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative rounded-xl border border-gray-800 bg-[#111111] p-6 shadow-lg">
                  {/* Solid background layer to prevent transparency */}
                  <div className="absolute inset-0 rounded-xl bg-[#111111]"></div>
