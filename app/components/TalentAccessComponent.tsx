...
// type DeveloperProfileProps = { developer: Developer; isFirst?: boolean };
...
// // Developer profile card component
// const DeveloperProfile = ({ developer, isFirst = false }: DeveloperProfileProps) => {
//   const [isHovered, setIsHovered] = useState(false);
...
//   const topTalents = useMemo(() => {
//     const sortedDevs = [...allDevelopers].sort((a, b) => (b.rating || 0) - (a.rating || 0));
//     return !activeJobType && !searchQuery ? sortedDevs.slice(0, 3) : [];
//   }, [activeJobType, searchQuery]);

//   // Filtered developers based on search query and active job type
//   const filteredDevelopers = useMemo(() => {
//     let filtered = topTalents.length > 0 ? topTalents : [...allDevelopers];
...
//                     {searchQuery ? 'Search Results' : 'Suggestions'}
//                   </div>
//                   <div className="custom-scrollbar max-h-[30rem] overflow-y-auto pr-1">
//                     <div className="space-y-4">
//                       {filteredDevelopers.map((dev, index) => (
//                         <DeveloperProfile key={dev.id} developer={dev} isFirst={index === 0} />
//                       ))}
//                     </div>
//                   </div>
//                 </>
